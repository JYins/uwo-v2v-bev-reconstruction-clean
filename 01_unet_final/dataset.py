...
class BEVReconstructionDataset(Dataset):
    def __init__(self, dataset_root, splits, augment=False, mask_variant="sector75"):
...
def get_dataloaders(
    ...
    train_dataset = BEVReconstructionDataset(dataset_root, train_splits, augment=True, mask_variant=mask_variant)
